...
import sumsubapp.accounts.fields
import sumsubapp.accounts.managers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', sumsubapp.accounts.fields.LowerCaseEmailField(error_messages={'unique': 'Oops! This email already exists.'}, max_length=254, unique=True, verbose_name='email')),
            ...
            managers=[
                ('objects', sumsubapp.accounts.managers.AccountManager()),
            ],
        ),
    ]
